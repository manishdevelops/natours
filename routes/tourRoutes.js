...
router.route('/:id').get(tourController.getTour)
    .patch(authController.protect, authController.restrictTo('admin', 'lead-guide'), tourController.upploadTourImages, tourController.resizeTourImages, tourController.updateTour)
