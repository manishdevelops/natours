...
exports.protect = catchAsync(async (req, res, next) => {
    ...
    res.locals.user = freshUser; //This makes the user information available to subsequent middleware functions or route handlers.
...
exports.isLoggedIn = async (req, res, next) => {
    try {
        ...
        if (req.cookies.jwt) {
            // verify token
            const decoded = await promisify(jwt.verify)(req.cookies.jwt, process.env.JWT_SECRET); // returns a fn then executes 
            ...
            res.locals.user = currentUser; //This makes the user information available to subsequent middleware functions or route handlers.
